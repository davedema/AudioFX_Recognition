...
def getpredictions(X_train_normalized, y_train, X_test_mc_normalized):
    ...
    for s in scores :
        score1 = cross_val_score(clf_01, X_01, y_01, cv=10, scoring=s)
        score2 = cross_val_score(clf_02, X_02, y_02, cv=10, scoring=s)
        score3 = cross_val_score(clf_12, X_12, y_12, cv=10, scoring=s)
